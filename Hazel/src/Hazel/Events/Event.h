...
namespace Hazel
{
	// now events is blocking
	// future a better stategy might be to buffer events in an event bus 
	...
	enum class EventType
	{
		...
		MouseButtonPressed, MouseButtomReleased, MouseMoved, MouseScrolled
	};
